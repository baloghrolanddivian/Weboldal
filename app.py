...
MANUFACTURING_BUNDLE_SCHEMA_VERSION = "2026-05-21-pantolo-strong-handle-qty-v64"
...
configure_vacation_calendar(RUNTIME_DIR / "szabadsag-naptar", _render_nettfront_layout)
...
class InvoiceHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if path == VACATION_CALENDAR_ROUTE:
            status, body = render_vacation_calendar_request(self.path)
    ...
    def do_POST(self):
        ...
        if path == VACATION_CALENDAR_DEPARTMENT_SAVE_ROUTE:
            ...
            status, body = handle_vacation_department_save(raw_body)
            self.send_response(status)
            self.send_header("Content-Type", "text/html; charset=utf-8")
            self.send_header("Cache-Control", "no-store")
            self.send_header("Content-Length", str(len(body)))
        ...
        if path == VACATION_CALENDAR_DEPARTMENT_DELETE_ROUTE:
            raw_body = self.rfile.read(int(self.headers.get("Content-Length", "0")))
            status, body = handle_vacation_department_delete(raw_body)
            self.send_response(status)
            self.send_header("Content-Type", "text/html; charset=utf-8")
            self.send_header("Cache-Control", "no-store")
            self.send_header("Content-Length", str(len(body)))
        ...
        if path == VACATION_CALENDAR_EMPLOYEE_SAVE_ROUTE:
            raw_body = self.rfile.read(int(self.headers.get("Content-Length", "0")))
            status, body = handle_vacation_employee_save(raw_body)
            self.send_response(status)
            self.send_header("Content-Type", "text/html; charset=utf-8")
            self.send_header("Cache-Control", "no-store")
            self.send_header("Content-Length", str(len(body)))
        ...
        if path == VACATION_CALENDAR_EMPLOYEE_DELETE_ROUTE:
            raw_body = self.rfile.read(int(self.headers.get("Content-Length", "0")))
            status, body = handle_vacation_employee_delete(raw_body)
            self.send_response(status)
            self.send_header("Content-Type", "text/html; charset=utf-8")
            self.send_header("Cache-Control", "no-store")
            self.send_header("Content-Length", str(len(body)))
        ...
        if path == VACATION_CALENDAR_LEAVE_SAVE_ROUTE:
            raw_body = self.rfile.read(int(self.headers.get("Content-Length", "0")))
            status, body = handle_vacation_leave_save(raw_body)
            self.send_response(status)
            self.send_header("Content-Type", "text/html; charset=utf-8")
            self.send_header("Cache-Control", "no-store")
            self.send_header("Content-Length", str(len(body)))
        ...
        if path == VACATION_CALENDAR_LEAVE_DELETE_ROUTE:
            raw_body = self.rfile.read(int(self.headers.get("Content-Length", "0")))
            status, body = handle_vacation_leave_delete(raw_body)
            self.send_response(status)
            self.send_header("Content-Type", "text/html; charset=utf-8")
            self.send_header("Cache-Control", "no-store")
            self.send_header("Content-Length", str(len(body)))
